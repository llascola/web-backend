...
func (_u *TagUpdate) AddPostIDs(ids ...uuid.UUID) *TagUpdate {
	_u.mutation.AddPostIDs(ids...)
	return _u
}

// AddPosts adds the "posts" edges to the BlogPost entity.
func (_u *TagUpdate) AddPosts(v ...*BlogPost) *TagUpdate {
...
// ClearPosts clears all "posts" edges to the BlogPost entity.
func (_u *TagUpdate) ClearPosts() *TagUpdate {
	_u.mutation.ClearPosts()
	return _u
}

// RemovePostIDs removes the "posts" edge to BlogPost entities by IDs.
func (_u *TagUpdate) RemovePostIDs(ids ...uuid.UUID) *TagUpdate {
	_u.mutation.RemovePostIDs(ids...)
	return _u
}

// RemovePosts removes "posts" edges to BlogPost entities.
func (_u *TagUpdate) RemovePosts(v ...*BlogPost) *TagUpdate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddPostIDs adds the "posts" edge to the BlogPost entity by IDs.
func (_u *TagUpdateOne) AddPostIDs(ids ...uuid.UUID) *TagUpdateOne {
	_u.mutation.AddPostIDs(ids...)
	return _u
}

// AddPosts adds the "posts" edges to the BlogPost entity.
func (_u *TagUpdateOne) AddPosts(v ...*BlogPost) *TagUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// RemovePostIDs removes the "posts" edge to BlogPost entities by IDs.
func (_u *TagUpdateOne) RemovePostIDs(ids ...uuid.UUID) *TagUpdateOne {
	_u.mutation.RemovePostIDs(ids...)
	return _u
}

// RemovePosts removes "posts" edges to BlogPost entities.
func (_u *TagUpdateOne) RemovePosts(v ...*BlogPost) *TagUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
