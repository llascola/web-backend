...
import (
	...
	"github.com/llascola/web-backend/internal/adapters/driven/repository/ent/migrate"
...
func (c *BlogPostClient) QueryTags(_m *BlogPost) *TagQuery {
...
func (c *TagClient) QueryPosts(_m *Tag) *BlogPostQuery {
...
type (
	hooks struct {
		BlogPost, Tag, User []ent.Hook
	}
	inters struct {
		BlogPost, Tag, User []ent.Interceptor
	}
)
